...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_BYE = 3,                        /* BYE  */
  YYSYMBOL_CD = 4,                         /* CD  */
  YYSYMBOL_UNSETENV = 5,                   /* UNSETENV  */
  YYSYMBOL_ANYSTRING = 6,                  /* ANYSTRING  */
  YYSYMBOL_LS = 7,                         /* LS  */
  YYSYMBOL_END = 8,                        /* END  */
  ...
  YYSYMBOL_SETENV = 15,                    /* SETENV  */
  YYSYMBOL_ALIAS = 16,                     /* ALIAS  */
  YYSYMBOL_OUTPUT = 17,                    /* OUTPUT  */
  YYSYMBOL_BACKSLASH = 18,                 /* BACKSLASH  */
  YYSYMBOL_YYACCEPT = 19,                  /* $accept  */
  YYSYMBOL_cmd_line = 20,                  /* cmd_line  */
  YYSYMBOL_built_in = 21                   /* built_in  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "BYE", "CD",
  "UNSETENV", "ANYSTRING", "LS", "END", "PIPE", "PRINTENV", "UNALIAS",
  "INPUT", "AND", "STRING", "SETENV", "ALIAS", "OUTPUT", "BACKSLASH",
  "$accept", "cmd_line", "built_in", YY_NULLPTR
};
...
{
      -3,    -5,    -9,    -8,     0,   -10,    -4,     1,     9,     3,
     -10,     6,     8,   -10,     4,     5,   -10,   -10,   -10,   -10,
      12,    13,   -10,   -10
};
...
{
       1,     2,     3,    10,     4,    11,    12,     5,    13,    16,
      14,    17,     6,     7,    18,    15,    19,     0,    20,    21,
      22,    23
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     8,     7,    14,    14,    10,     8,     0,
      14,     8,    15,    16,     8,    14,     8,    -1,    14,    14,
       8,     8
};
...
{
       0,     3,     4,     5,     7,    10,    15,    16,    20,    21,
       8,    14,    14,     8,    14,    14,     0,     8,     8,     8,
      14,    14,     8,     8
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* cmd_line: built_in END  */
#line 33 "nutshparser.y"
                                        {return 1;}
#line 1098 "nutshparser.tab.c"
    break;

  case 3: /* built_in: BYE END  */
#line 36 "nutshparser.y"
                                                {exit(1); return 1; }
#line 1104 "nutshparser.tab.c"
    break;

  case 4: /* built_in: CD STRING END  */
#line 37 "nutshparser.y"
                                                {runCD((yyvsp[-1].string)); return 1;}
#line 1110 "nutshparser.tab.c"
    break;

  case 5: /* built_in: ALIAS STRING STRING END  */
#line 38 "nutshparser.y"
                                                {runSetAlias((yyvsp[-2].string), (yyvsp[-1].string)); return 1;}
#line 1116 "nutshparser.tab.c"
    break;

  case 6: /* built_in: LS END  */
#line 39 "nutshparser.y"
                                                                {runLS(); return 1;}
#line 1122 "nutshparser.tab.c"
    break;

  case 7: /* built_in: PRINTENV  */
#line 40 "nutshparser.y"
                                                                {runPrintEnv();}
#line 1128 "nutshparser.tab.c"
    break;

  case 8: /* built_in: SETENV STRING STRING END  */
#line 41 "nutshparser.y"
                                                {runSetEnv((yyvsp[-2].string), (yyvsp[-1].string)); return 1;}
#line 1134 "nutshparser.tab.c"
    break;

  case 9: /* built_in: UNSETENV STRING END  */
#line 42 "nutshparser.y"
                                                        {runUnsetEnv((yyvsp[-1].string)); return 1;}
#line 1140 "nutshparser.tab.c"
    break;


#line 1144 "nutshparser.tab.c"
